...
/***/ function(module, exports, __webpack_require__) {
	...
	var _electron = __webpack_require__(238);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Merch = __webpack_require__(234);
	...
	exports.default = _react2.default.createElement(
	  ...
	  _react2.default.createElement(_reactRouter.Route, { path: '/slides', component: _Content2.default }),
	      ...
	      return _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  _reactRouter.Link,
	                  { to: '/slides', activeStyle: { color: '#00d8ff' } },
	                  'Homepage Slides'
	                )
	              ),
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  _reactRouter.Link,
	                  { to: '/merch', activeStyle: { color: '#00d8ff' } },
	                  'MerchPack'
	                )
	              )
	            )
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  'a',
	                  { className: 'react-link', href: 'https://facebook.github.io/react/' },
	                  _react2.default.createElement('img', { width: '36', height: '36', src: 'img/react-logo.svg' }),
	                  'React'
	                )
	              )
	            )
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'a',
	              { href: 'https://github.com/suprsidr/force-components' },
	              'Github'
	            )
	          ),
	          _react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _OutputSlide = __webpack_require__(209);

	var _OutputSlide2 = _interopRequireDefault(_OutputSlide);

	var _html = __webpack_require__(210);

	var _html2 = _interopRequireDefault(_html);

	var _Slides = __webpack_require__(211);
	...
	var Content = function (_Component) {
	  ...
	  _createClass(Content, [{
	    key: 'updateState',
	    value: function updateState(obj, cb) {
	      var _this2 = this;
	    ...
	    value: function onChange(e) {
	      ...
	      this.updateState({
	        ...
	        var ta = _this3.refs.textarea;
	        ta.value = _this3.setTextAreaValue();
	      });
	    }
	  }, {
	    key: 'setTextAreaValue',
	    value: function setTextAreaValue() {
	      var _this4 = this;

	      var result = '';
	      this.state.slides.forEach(function (slide, i) {
	        result += _html2.default.prettyPrint(_server2.default.renderToStaticMarkup(_react2.default.createElement(_OutputSlide2.default, { slides: _this4.state.slides, index: i })));
	        result += '\n';
	        result += '\n';
	      });
	      return result;
	    ...
	    key: 'getElements',
	    value: function getElements(html) {
	      var element = document.createElement('div');
	      element.innerHTML = html;
	      var anchors = Array.from(element.querySelectorAll('a')).map(function (a) {
	        return {
	          href: a.getAttribute("href").trim(), // literal path
	          className: Array.from(a.classList),
	          img: Array.from(a.querySelectorAll('img')).map(function (img) {
	            return {
	              alt: img.alt || null,
	          ...
	          section: Array.from(a.querySelectorAll('section')).map(function (section) {
	            return { text: section.textContent };
	          }),
	          heading: Array.from(a.querySelectorAll('h2')).map(function (header) {
	    ...
	    key: 'toggleShowMobile',
	    value: function toggleShowMobile(e) {
	      e.preventDefault();
	      this.setState({
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            { className: 'button', onClick: function onClick(e) {
	                return _this5.toggleShowMobile(e);
	              } },
	            'Toggle Mobile'
	          )
	        ),
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(_Slides2.default, {
	            ...
	            updateState: function updateState(obj) {
	              return _this5.updateState(obj, function () {
	                var ta = _this5.refs.textarea;
	                ta.value = _this5.setTextAreaValue();
	              });
	            },
	            showMobile: this.state.showMobile })
	        ),
	        _react2.default.createElement(
	          'div',
	          { className: 'small-12 columns' },
	          _react2.default.createElement('textarea', { ref: 'textarea', placeholder: 'Paste HTML Here', onChange: function onChange(e) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OutputSlide = function (_Component) {
	  _inherits(OutputSlide, _Component);

	  function OutputSlide() {
	    _classCallCheck(this, OutputSlide);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(OutputSlide).apply(this, arguments));
	  }

	  _createClass(OutputSlide, [{
	    key: 'render',
	    value: function render() {
	      var slide = this.props.slides[this.props.index];
	      ...
	      return _react2.default.createElement(
	        'a',
	        { href: slide.href, className: slide.className.join(' ') },
	        _react2.default.createElement('img', slide.img[0]),
	        _react2.default.createElement(
	          'section',
	          null,
	          slide.section[0].text
	        ),
	        _react2.default.createElement(
	          'h2',
	          null,
	          slide.heading[0].text
	        )
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Slides = function (_Component) {
	  ...
	  _createClass(Slides, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        { id: 'slider', className: 'nivoSlider home_mainGlam' },
	        this.props.slides.map(function (slide, i) {
	          return _react2.default.createElement(_Slide2.default, _extends({}, _this2.props, {
	            index: i,
	            key: i }));
	        })
	      );
	...
	Slides.propTypes = {
	  updateState: _react2.default.PropTypes.func,
	  slides: _react2.default.PropTypes.array.isRequired
	};
	  ...
	  _createClass(Slide, [{
	    ...
	    value: function save(e) {
	      ...
	      slides[this.props.index] = {
	        ...
	        heading: [{ text: this.refs.heading.value }],
	        section: [{ text: this.refs.section.value }]
	      };
	    ...
	    key: 'renderItemOrEdit',
	    value: function renderItemOrEdit() {
	      var _this2 = this;
	      ...
	      if (this.state.editing) {
	        return _react2.default.createElement(
	          'a',
	          { href: slide.href, 'data-idx': this.props.index, className: 'editable-item ' + slide.className.join(' '), onClick: function onClick(e) {
	              return e.preventDefault();
	            }, draggable: false },
	          _react2.default.createElement('img', _extends({ 'data-idx': this.props.index }, slide.img[0])),
	          _react2.default.createElement(
	            _reactModal2.default,
	            { isOpen: this.state.editing, style: customStyles },
	            _react2.default.createElement(
	              'div',
	              { className: 'row edit-box' },
	              _react2.default.createElement(
	                'div',
	                { className: 'small-12 columns' },
	                _react2.default.createElement(
	                  ...
	                  null,
	                  'Link:',
	                  _react2.default.createElement('input', { ref: 'href', defaultValue: slide.href, style: { width: '100%' } })
	                ),
	                _react2.default.createElement(
	                  'label',
	                  null,
	                  'Alt Text:',
	                  _react2.default.createElement('input', { ref: 'alt', defaultValue: slide.img[0].alt, style: { width: '100%' } })
	                ),
	                _react2.default.createElement(
	                  'label',
	                  null,
	                  'Image Source:',
	                  _react2.default.createElement('input', { ref: 'data-source', defaultValue: slide.img[0]['data-source'], style: { width: '100%' } })
	                ),
	                _react2.default.createElement(
	                  'label',
	                  null,
	                  'Image Mobile Source:',
	                  _react2.default.createElement('input', { ref: 'data-mobile-source', defaultValue: slide.img[0]['data-mobile-source'] || '', style: { width: '100%' } })
	                ),
	                _react2.default.createElement(
	                  'label',
	                  null,
	                  'Tab Text:',
	                  _react2.default.createElement('input', { ref: 'heading', defaultValue: slide.heading[0].text, style: { width: '100%' } })
	                ),
	                _react2.default.createElement(
	                  'label',
	                  null,
	                  'Teaser Text:',
	                  _react2.default.createElement('input', { ref: 'section', defaultValue: slide.section[0].text, style: { width: '100%' } })
	                ),
	                _react2.default.createElement('input', { type: 'hidden', ref: 'className', defaultValue: slide.className.join(' ') }),
	                _react2.default.createElement(
	                  'button',
	                  { className: 'saver button', onClick: function onClick(e) {
	                ...
	                _react2.default.createElement(
	                  'i',
	                  { title: 'Close', href: '#close', className: 'edit-icon-link', onClick: function onClick(e) {
	                      return _this2.toggleEditing(e);
	                    } },
	                  _react2.default.createElement(
	                    'svg',
	        ...
	        return _react2.default.createElement(
	          ...
	          { href: slide.href, 'data-idx': this.props.index, className: 'editable-item ' + slide.className.join(' '), onClick: function onClick(e) {
	              ...
	              return _this2.dragStarted(e);
	            }, onDragOver: function onDragOver(e) {
	              return _this2.draggingOver(e);
	            }, onDragEnter: function onDragEnter(e) {
	              return _this2.dragEnter(e);
	            }, onDragLeave: function onDragLeave(e) {
	              return _this2.dragLeave(e);
	            }, onDrop: function onDrop(e) {
	              return _this2.dropped(e);
	            } },
	          _react2.default.createElement('img', _extends({ 'data-idx': this.props.index }, slide.img[0])),
	          _react2.default.createElement(
	            'section',
	          ...
	          this.props.updateState && _react2.default.createElement(_Toolbar2.default, { onClick: function onClick(e) {
	              return _this2.toggleEditing(e);
	            } })
	        );
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ModalPortal = React.createFactory(__webpack_require__(216));
	var ariaAppHider = __webpack_require__(231);
	var elementClass = __webpack_require__(232);
	var renderSubtreeIntoContainer = __webpack_require__(157).unstable_renderSubtreeIntoContainer;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var focusManager = __webpack_require__(217);
	var scopeTab = __webpack_require__(219);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var findTabbable = __webpack_require__(218);
	  ...
	  _createClass(Toolbar, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          "i",
	          { title: "Edit", href: "#edit", className: "edit-icon-link", onClick: function onClick(e) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MerchPack = __webpack_require__(235);

	var _MerchPack2 = _interopRequireDefault(_MerchPack);
	...
	var Merch = function (_Component) {
	  ...
	  function Merch() {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(Merch).apply(this, arguments));
	  }
	  ...
	  _createClass(Merch, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_MerchPack2.default, null)
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _EditableAnchor = __webpack_require__(236);

	var _EditableAnchor2 = _interopRequireDefault(_EditableAnchor);
	...
	var MerchPack = function (_Component) {
	  _inherits(MerchPack, _Component);

	  function MerchPack(props) {
	    _classCallCheck(this, MerchPack);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(MerchPack).call(this, props));

	    _this.renderingOutput = false, _this.state = {
	      elements: []
	    };
	    return _this;
	  }

	  _createClass(MerchPack, [{
	    key: 'updateState',
	    value: function updateState(els, cb) {
	      var _this2 = this;

	      this.setState({ elements: els }, function () {
	        cb && cb();
	    ...
	    key: 'updateStateFromChild',
	    value: function updateStateFromChild(obj) {
	      var _this3 = this;
	      ...
	      keys.forEach(function (key) {
	        var arr = key.split('_');
	        var last = arr.pop();
	        var el = arr.reduce(function (prev, next) {
	          return prev[next];
	        }, elements);
	        el[last] = obj[key];
	      });
	      this.updateState(elements, function () {
	        var ta = _this3.refs.textarea;
	        ta.value = _this3.setTextAreaValue();
	      });
	    }
	    ...
	    value: function onChange(e) {
	      ...
	      this.updateState(Array.from(el.children).map(function (e, i) {
	        return _this4.getDomMap(e, i);
	      }));
	    }
	  }, {
	    key: 'setTextAreaValue',
	    value: function setTextAreaValue() {
	      ...
	      var result = _html2.default.prettyPrint(_server2.default.renderToStaticMarkup(_react2.default.createElement('junk', {}, this.state.elements.map(function (el) {
	        return _this5.createElement(el);
	      }))).replace(/(^<junk>|<\/junk>$)/g, ''));
	    ...
	    key: 'getDomMap',
	    value: function getDomMap(el, id) {
	      var _this6 = this;

	      return {
	        attributes: Array.from(el.attributes).reduce(function (prev, next) {
	          if (next.name === 'class') {
	            return prev;
	          }
	          // style needs to be converted to an object and camelCase any dashed declarations;
	          if (next.name === 'style') {
	            prev[next.name] = next.value.replace(/(\;$|\s)/g, '').replace(/-(.)/g, function ($0, $1) {
	        ...
	        children: Array.from(el.childNodes).reduce(function (prev, next) {
	          var i = prev.length;
	          if (next.nodeType === 3 && next.textContent !== '') {
	            var txt = next.textContent.replace(/[\t\r\n]/gm, '').replace(/\s{2,}/g, ' ');
	            if (txt.match(/[\d\w]/g)) {
	              console.log('txt: ', txt);
	              var clist = Array.from(el.classList);
	            ...
	            prev.push(_this6.getDomMap(next, id + '_children_' + i));
	          }
	          return prev;
	        }, []),
	    ...
	    key: 'renderChildren',
	    value: function renderChildren(tag) {
	      return tag !== 'img';
	    }
	  }, {
	    key: 'renderEditable',
	    value: function renderEditable(tag) {
	      return tag === 'a' && !this.renderingOutput ? _EditableAnchor2.default : tag;
	    }
	  }, {
	    key: 'createElement',
	    value: function createElement(el) {
	      ...
	      el.attributes.updateState = !this.renderingOutput ? function (obj) {
	        return _this7.updateStateFromChild(obj);
	      } : null;
	      var children = el.children.map(function (child) {
	        return _this7.createElement(child);
	      });
	      if (el.tag === '') {
	      ...
	      return _react2.default.createElement(this.renderEditable(el.tag), el.attributes, this.renderChildren(el.tag) ? children : undefined);
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'small-12 columns' },
	          _react2.default.createElement('textarea', { ref: 'textarea', placeholder: 'Paste HTML Here', style: { display: 'block', width: '100%', height: '400px' }, onChange: function onChange(e) {
	              return _this8.onChange(e);
	            } })
	        ),
	        _react2.default.createElement(
	          'div',
	          ...
	          this.state.elements.map(function (el) {
	            return _this8.createElement(el);
	          })
	        )
	      );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EditableAnchor = function (_Component) {
	  _inherits(EditableAnchor, _Component);

	  function EditableAnchor(props) {
	    _classCallCheck(this, EditableAnchor);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(EditableAnchor).call(this, props));
	  ...
	  _createClass(EditableAnchor, [{
	    ...
	    value: function save(e) {
	      ...
	      e.preventDefault();
	      this.props.updateState(this.fields.reduce(function (prev, next) {
	        prev[next] = _this2.refs[next].value;
	        return prev;
	      }, {}));
	      this.toggleEditing(e);
	    }
	    ...
	    value: function toggleEditing(e) {
	      e.preventDefault();
	      e.stopPropagation();
	      var styles = window.getComputedStyle(this.refs.editable, null);
	      this.setState({
	        editing: !this.state.editing,
	        dims: {
	    ...
	    key: 'getEditFields',
	    value: function getEditFields(id) {
	      var _this3 = this;
	      ...
	      var _id = _el$attributes._id;
	      var key = _el$attributes.key;
	      var className = _el$attributes.className;
	      var updateState = _el$attributes.updateState;
	      var elements = _el$attributes.elements;

	      var props = _objectWithoutProperties(_el$attributes, ['_id', 'key', 'className', 'updateState', 'elements']);
	      // attributes
	      ...
	      for (var prop in props) {
	        if (props.hasOwnProperty(prop)) {
	          ...
	          retval.push(_react2.default.createElement('label', { key: prop + '_' + _id }, [prop + ':', _react2.default.createElement('input', { key: _id + '_' + prop, ref: _id + '_attributes_' + prop, defaultValue: props[prop], style: { width: '100%' } })]));
	      ...
	      if (Array.isArray(el.children)) {
	        el.children.forEach(function (child) {
	          retval = retval.concat(_this3.getEditFields(child.attributes._id));
	        });
	      }
	      // textContent
	      if (el.textContent !== '') {
	        retval.push(_react2.default.createElement('label', { key: 'textContent_' + _id }, [el.tag + ' ' + (className || '') + ' Text ' + _id.slice(-1) + ':', _react2.default.createElement('input', { key: _id + '_textContent', ref: _id + '_textContent', defaultValue: el.textContent, style: { width: '100%' } })]));
	    ...
	    value: function renderItemOrEdit() {
	      ...
	      var updateState = _props.updateState;
	      var children = _props.children;
	      var textContent = _props.textContent;

	      var props = _objectWithoutProperties(_props, ['className', 'updateState', 'children', 'textContent']);
	      ...
	      if (this.state.editing) {
	        return _react2.default.createElement(
	          'div',
	          { ref: 'editable', style: this.state.dims },
	          _react2.default.createElement(
	            _reactModal2.default,
	            { isOpen: this.state.editing, style: customStyles },
	            _react2.default.createElement(
	              'div',
	              { className: 'row edit-box', style: { position: 'relative' } },
	              _react2.default.createElement(
	                'div',
	                { className: 'small-12 columns' },
	        ...
	        return _react2.default.createElement(
	          'a',
	          _extends({ ref: 'editable' }, props, { className: 'editable-item ' + className, onClick: function onClick(e) {
	              return e.preventDefault();
	            } }),
	          children,
	          this.props.updateState && _react2.default.createElement(_Toolbar2.default, { onClick: function onClick(e) {
	...
	exports.default = EditableAnchor;
